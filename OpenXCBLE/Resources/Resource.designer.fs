...
[<assembly: Android.Runtime.ResourceDesignerAttribute("OpenXCBLE.Resource", IsApplication=true)>]
do ()
namespace OpenXCBLE
    ...
    and
        ...
        (* partial *)Resource_Drawable () =
            ...
            static member reccircle = 2130837505
            (* Member of type 'CodeTypeConstructor' is not supported by the CodeDOM provider and was omitted *)
    ...
    and
        ...
        (* partial *)Resource_Id () =
            ...
            static member tglSwitch = 2131034114
